...
Scenario: Scroll to recommanded video 
	And I am in discovery home page
...
Scenario: Validating added video details in myvideos page
	...
	And I scroll to Favorite shows section
	...
	And The description of the first video should match with the title of first recommended video of home page
